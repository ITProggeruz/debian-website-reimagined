...
let previous_button = window.document.querySelector(
...
function changeTestimonial() {
  ...
  testimonials_list[previous_testimonial].classList.remove(
  ...
  next_testimonial =
    (next_testimonial + 1) / testimonials_list.length != 1
      ? next_testimonial + 1
      : 0;
...
previous_button.addEventListener("click", () => {
  ...
  previous_testimonial =
    previous_testimonial - 1 < 0
      ? testimonials_list.length - 1
      : previous_testimonial - 1;
